...
Controller: Artem Samsonov, Spain. Email: legal@transcriptor-mcp.org. You may also write to us by post at the address in section 1 of the [Terms of Service](./TERMS_OF_SERVICE.md). If a message to legal@transcriptor-mcp.org comes back undelivered, use that address.